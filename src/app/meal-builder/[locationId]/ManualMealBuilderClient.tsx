                ...
                <AnimatePresence initial={false} mode="popLayout">
                  {computed.lines.map((line) => (
                    <motion.article
                      ...
                      exit={reduceMotion ? { opacity: 1 } : { opacity: 0, x: -8, scale: 0.985 }}
                      transition={reduceMotion ? { duration: 0 } : { duration: 0.3, ease: [0.22, 1, 0.36, 1], layout: { duration: 0.34, ease: [0.22, 1, 0.36, 1] } }}
                    >
