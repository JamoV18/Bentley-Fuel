      ...
      <div className="mt-6 grid items-start gap-6 xl:grid-cols-[.88fr_1.12fr]">
        <div className="min-w-0 space-y-5 xl:sticky xl:top-6 xl:self-start">
          <section className="surface p-5 sm:p-6" aria-labelledby="manual-meal-heading">
            ...
            {build.items.length === 0 ? <p className="mt-4 rounded-2xl border border-dashed border-black/10 bg-black/[.02] p-4 text-sm subtle">Nothing added yet. Choose foods from the stations on the right.</p> : <div className="mt-4 space-y-4">{computed.lines.map((line) => (
