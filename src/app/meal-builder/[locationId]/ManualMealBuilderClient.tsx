...
export default function ManualMealBuilderClient({ locationId, initialMenuItemId, resources, isDemo }: { locationId: string; initialMenuItemId?: string; resources: MealBuildResources; isDemo: boolean }) {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-7 sm:py-12">
      ...
      <header className="mt-5"><p className="brand-kicker">Bentley Fuel</p><h1 className="mt-4 text-4xl font-bold tracking-[-0.04em] sm:text-5xl">Build my meal</h1><p className="mt-2 subtle">Already know what you’re eating? Add it here. Bentley Fuel will total the meal and keep your day up to date.</p></header>
      <AppNav />
