...
export default function OnboardingPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-5xl flex-1 px-6 py-8 sm:py-12">
      ...
      <section className="surface relative mt-6 overflow-hidden p-6 sm:p-8 lg:p-10">
        <AnimatePresence initial={false} mode="popLayout" custom={stepDirection}>
          <motion.div
            key={step}
            custom={stepDirection}
            initial={reduceMotion ? false : { opacity: 0.94, x: stepDirection * 18 }}
            animate={{ opacity: 1, x: 0 }}
            exit={reduceMotion ? { opacity: 1, x: 0 } : { opacity: 0.94, x: stepDirection * -18 }}
