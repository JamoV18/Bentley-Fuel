    ...
    <main className="mx-auto w-full max-w-5xl flex-1 px-6 py-8 sm:py-12">
      ...
      <AnimatePresence initial={false} mode="popLayout" custom={stepDirection}>
        <motion.section
          ...
          initial={reduceMotion ? false : { opacity: 0.92, x: stepDirection * 28 }}
          animate={{ opacity: 1, x: 0 }}
          exit={reduceMotion ? { opacity: 1, x: 0 } : { opacity: 0.92, x: stepDirection * -28 }}
