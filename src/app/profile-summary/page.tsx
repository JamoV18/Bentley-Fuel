...
export default function ProfileSummary() {
  ...
  return (
    <main className="summary">
      ...
      <p className="mt-2 subtle">The quiet engine underneath Today and every meal recommendation.</p>
      <AppNav />
