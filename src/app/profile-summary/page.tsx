      ...
      <section className="mt-7 rounded-2xl border border-black/10 bg-white p-5 shadow-sm">
        ...
        {profile.maintenanceEstimate && (
          <div className="mt-6 border-t border-black/10 pt-5">
            ...
            <p className="mt-1 text-sm text-black/60">Estimated energy needed to maintain your current body weight. Bentley Fuel uses this as the evidence-based energy baseline for derived daily targets.</p>
          </div>
        )}

        {profile.dailyTargets ? (
          <>
            <h2 className="mt-6 border-t border-black/10 pt-5 font-semibold">Daily nutrition targets</h2>
            <p className="mt-1 text-sm leading-relaxed text-black/60">Bentley Fuel uses these to track what you actually finish and adjust later recommendations against what remains for the day.</p>
