  ...
  return (
    <section className="surface p-5 sm:p-6 lg:col-span-8">
      ...
      <p className="mt-2 max-w-3xl text-sm leading-relaxed subtle">
        In the current prototype, your profile, meal history, weight check-ins, and activity reviews are stored only in this browser on this device. Falcon Fuel keeps recommended, selected, confirmed-eaten, and confirmed-plan behavior conceptually separate so future personalization does not treat a shown recommendation or unconfirmed activity change as something you did.
      </p>
      ...
      <div className="mt-5 flex flex-wrap gap-3 border-t border-black/[.06] pt-5">
        ...
        {!confirmingReset ? (
          ...
          <div className="flex flex-wrap items-center gap-2 rounded-2xl border border-red-200 bg-red-50 p-2">
            <span className="px-2 text-xs font-semibold text-red-900">This removes your profile, meal history, weight check-ins, and activity reviews from this browser.</span>
