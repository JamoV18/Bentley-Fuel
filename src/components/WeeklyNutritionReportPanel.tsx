    ...
    <section className="surface mt-5 p-5 sm:p-6">
      ...
      {report.status === "empty" ? (
        ...
        <>
          ...
          <details className="mt-4 rounded-2xl border border-black/[.06] bg-white/60 p-1 open:bg-white/75">
            <summary className="cursor-pointer list-none rounded-xl px-4 py-3 text-sm font-bold text-emerald-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-700">
              View weekly details
            </summary>
            <div className="border-t border-black/[.06] px-3 pb-3 pt-4 sm:px-4">
              <div className="grid gap-3 lg:grid-cols-2">
                <div className="rounded-2xl border border-black/[.06] bg-white/80 p-4 sm:p-5">
              ...
              {(dining || interactions) && (
                <div className="mt-3 grid gap-3 lg:grid-cols-2">
                  {dining && (
                    <div className="rounded-2xl border border-black/[.06] bg-white/80 p-4">
