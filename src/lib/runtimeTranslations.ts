...
const COMMON: Record<string, Entry> = {
  ...
  "About 20% below estimated maintenance. Bentley Fuel's stronger balanced option.": { es: "Aproximadamente 20% por debajo del mantenimiento estimado. La opción equilibrada más intensa de Bentley Fuel.", zh: "约低于估算维持热量 20%。这是 Bentley Fuel 较强但仍平衡的选项。" },
  ...
  "Bentley Fuel turns this profile into meals and adapts as you track.": { es: "Bentley Fuel convierte este perfil en comidas y se adapta a medida que registras.", zh: "Bentley Fuel 会把这份资料转化为餐食建议，并随着你的记录持续调整。" },
